...
response = generative_ai_client.list_work_requests("ocid1.tenancy.oc1..aaaaaaaa6xo4q4r2l2nvcr3sl657pwla5k3xtbk2s6vgyrvxfuh4p66frooq")

print("**************************ListWorkRequests Result**************************")
print(response.data)